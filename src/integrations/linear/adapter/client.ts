...
/** Options for creating a Linear issue gateway. Credentials are injected. */
...
function toSnapshot(issue: Issue, stateName: string | null = null): LinearIssueSnapshot {
  return {
    id: issue.id,
...
/**
 * Create a Linear issue gateway backed by the Linear SDK.
 ...
 */
export function createLinearClient(enabled: boolean, options: LinearClientOptions = {}): LinearIssueGateway | null {
