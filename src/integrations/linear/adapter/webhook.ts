...
import type { LinearWebhookEvent, LinearWebhookIngest, LinearWebhookSignatureVerifier } from './types';
...
/** Parse a raw Linear webhook HTTP body + headers into a typed LinearWebhookEvent. */
...
/**
 * Create a LinearWebhookIngest that validates the presence of a Linear-Signature header
...
/**
 * Create a LinearWebhookSignatureVerifier for Linear's HMAC-SHA256 signing scheme.
